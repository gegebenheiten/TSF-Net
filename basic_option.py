...
class SimpleOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--data_root_dir', type=str, default='data/bs_ergb', help='root directory for data')
        ...
        self.parser.add_argument('--image_height', default=256, type=int, metavar='image height')
        self.parser.add_argument('--image_width', default=256, type=int, metavar='image width')
